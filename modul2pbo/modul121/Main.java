...
public class Main {
    ...
    static User[] userStudents = {
        new Student("Who", "202210370311203", "Engineering", "Computer Science"),
        new Student("Iqbal", "202310370311122", "Business", "Finance")
    };
    static Admin admin = new Admin("admin", "admin");

    public static void main(String[] args) {
        bookList.addBook(new Book(1, "Sejarah 1", "Jhone", 10));
        bookList.addBook(new Book(2, "Sejarah 2", "Thomas Cormen", 5));
